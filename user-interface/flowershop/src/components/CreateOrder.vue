...
export default {
  data() {
    return {
      ...
      state: "",
      zip: "",
      provoEci: "DktQsvscABRzMz6Ck6vRgT",
  ...
  methods: {
    submitOrder() {
      ...
      let requestUrl = `${this.baseUrl}event/${eci}${this.eventUrl}?shopLocation=${this.shopLocation},Utah&price=${this.price}&address=${location}&user=${this.customerName}&itemID=${this.itemID}`;
